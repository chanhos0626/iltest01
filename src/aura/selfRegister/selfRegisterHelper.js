({
    ...
    handleSelfRegister: function (component, event, helpler) {
        ...
        var profileId = '00e7F000000y4rDQAQ';
        win.console.log('profileId',profileId);
        startUrl = decodeURIComponent(startUrl);
        
        action.setParams({firstname:firstname,lastname:lastname,email:email,
                password:password, confirmPassword:confirmPassword, accountId:accountId, regConfirmUrl:regConfirmUrl, extraFields:extraFields, startUrl:startUrl, includePassword:includePassword, profileId:profileId});
